  ...
  document.addEventListener('DOMContentLoaded', function() {
    ...
    function makeBadgeChart(elId, yearBadges, badges) {
      ...
      chart.setOption({
        ...
        grid: { containLabel: true, left: 20, right: 20, bottom: 50, top: 20 },
        xAxis: { type: 'category', data: years },
    ...
    if (compareEl) {
      ...
      cChart.setOption({
        ...
        grid: { containLabel: true, left: 20, right: 20, bottom: 60, top: 20 },
        xAxis: { type: 'category', data: years },
    ...
    function makeInstScatter(sysData, secData) {
      ...
      chart.setOption({
        ...
        grid: { containLabel: true, left: 20, right: 20, bottom: 40, top: 50 },
        xAxis: { type: 'value', name: 'Artifact Score', min: 0 },
